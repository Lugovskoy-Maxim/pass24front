...
export const ALL_PERMISSIONS = [
  ...
  {
    key: 'passes.view_own',
    label: 'Просмотр своих пропусков',
    group: 'Пропуска',
  },
  {
    key: 'passes.view_all',
    label: 'Просмотр всех пропусков',
    group: 'Пропуска',
  },
  { key: 'passes.approve', label: 'Одобрение и отклонение', group: 'Пропуска' },
  {
    key: 'passes.reception',
    label: 'Вход / выход посетителей',
    group: 'Ресепшн',
  },
  ...
  {
    key: 'admin.offices',
    label: 'Управление офисами',
    group: 'Администрирование',
  },
  {
    key: 'admin.settings',
    label: 'Базовые настройки сайта',
    group: 'Администрирование',
  },
  {
