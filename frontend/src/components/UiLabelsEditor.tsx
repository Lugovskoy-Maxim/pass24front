...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { path: 'buttons.share', label: 'Поделиться (кнопка)' },
      { path: 'buttons.copyLink', label: 'Скопировать ссылку' },
      { path: 'buttons.shareSocial', label: 'В соцсети' },
      { path: 'buttons.sendToEmail', label: 'Отправить на почту' },
      { path: 'buttons.sendEmailTitle', label: 'Заголовок модалки почты' },
