...
export function PassTicketView({ ticket, enableEmailShare = false }: PassTicketViewProps) {
      ...
      >
        ...
        <div className="text-center border-b border-[var(--border)] pb-4 mb-5">
          <div className="flex items-center justify-center gap-2 text-[var(--primary)] mb-1">
            ...
            <span className="font-bold text-lg">{ticket.businessCenterName || 'Бизнес-центр'}</span>
          </div>
